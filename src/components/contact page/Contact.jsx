          ...
          <div>
            ...
            {!messageSent ? (
              <form onSubmit={handleFormSubmit}>
                <div className='flex flex-col lg:grid grid-cols-2 mx-10 lg:ml-20 lg:mr-0 mt-2 md:mt-10 lg:space-x-5'>
                ...
                <div className='flex flex-col mx-10 lg:ml-20 lg:mr-0 mt-2 md:mt-10'>
                ...
                <div className='flex justify-end mx-10 lg:ml-20 lg:mr-0 mt-10'>
                  <button type='submit' className='flex flex-row items-center border-2 border-black rounded-lg px-6 py-2 text-xl send-button'><p className='mr-2'>send</p><RxPaperPlane className={`${formSubmitted && "paper-plane"}`} /></button>
                </div>
              </form>
            ) : (
              ...
              <div className='flex flex-col justify-center items-center mx-10 mt-2 md:mt-10 message-sent'>
                ...
                <div className='flex justify-center mt-10'>
                  <button onClick={() => {setMessageSent(false); setFormSubmitted(false)}} className='border-2 border-black rounded-lg px-6 py-2 text-x back-button'>
                    back
                  </button>
                </div>
              </div>
